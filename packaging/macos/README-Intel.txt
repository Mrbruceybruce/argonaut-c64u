Argonaut macOS test build — Intel (x86_64), macOS 15 or newer
...
Experimental Intel package: automated startup checks do not replace testing on a physical Intel Mac.
