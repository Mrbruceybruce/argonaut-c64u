...
TASKS = (
    ...
    'Open a D64 directory. Confirm Extract, Add, Rename, and Remove show clear icons with identifying tooltips; Discard changes and Save image as… are separate at the right; the title does not show an I-beam; and unsaved staged changes still require confirmation before closing. Move the pointer over the dialog above rows in the underlying Files panes and confirm those rows do not show hover highlighting. Close the dialog and confirm Files responds normally.',
